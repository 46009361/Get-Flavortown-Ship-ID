(The repo description has exactly 69 characters? Unreal!)

Anyway…

# Get Flavortown Ship ID

A Chrome extension for Flavortown that tells you the ship ID when you're voting on a new project. For example, an ID of 1234 is the 1234th ship across all of Flavortown.
